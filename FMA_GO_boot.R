...
# Figure 6
args<-c("180319","180319","preSMA-post","M1-RH",11,11,500,10,2,2)
# Figure 7
args<-c("180319","180319","preSMA-ant","M1-RH",11,11,500,10,2,3)
...
##############################################################################
# load data
load(paste0("Data_GO_",M.label,"_",R.label,".RData"))
##############################################################################
...
re.CV.FMA<-FMA.historical.CV(Z,M,Y,delta.grid1=delta.grid1,delta.grid2=delta.grid2,delta.grid3=delta.grid3,
...
# FMA output
re.FMA<-FMA.historical(Z,M,Y,delta.grid1=delta.grid1,delta.grid2=delta.grid2,delta.grid3=delta.grid3,
                       intercept=intercept,basis1=basis1,Ld2.basis1=Ld2.basis1,basis2=basis2,Ld2.basis2=Ld2.basis2,timeinv=timeinv,timegrids=timegrids,
...
save(list=c("re.CV.FMA","re.FMA","IEsub.est","DEsub.est"),file=paste0("FMA_GO_boot_",M.label,"_",R.label,"_MZ",delta.grid1,"_YZ",delta.grid2,"_YM",delta.grid3,".RData"))

##############################################################################
# plot and summary

load(paste0("FMA_GO_boot_",M.label,"_",R.label,"_MZ",delta.grid1,"_YZ",delta.grid2,"_YM",delta.grid3,".RData"))
